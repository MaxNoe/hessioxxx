 ...
 *
 *  @date    @verbatim CVS $Date: 2015/06/15 17:40:58 $ @endverbatim
 *  @version @verbatim CVS $Revision: 1.91 $ @endverbatim
 */
...
#  define H_MAX_TEL 640 /* prod2: 197 + 111 + 102, so we can merge data from three simulations */
#  define H_MAX_PIX 11328
#  ifndef H_MAX_TRG_PER_SECTOR
#   define H_MAX_TRG_PER_SECTOR 3
#  endif
...
#endif
#ifdef H_SAVE_MEMORY
# if defined(CTA_PROD2) || defined(CTA_SC) || defined(CTA_PROD2_SC) || defined(CTA_PROD3) || defined(CTA_PROD3_SC)
